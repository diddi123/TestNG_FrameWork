 ...
 * org.testng.SkipException; import org.testng.annotations.AfterMethod; import
 ...
 * 
 * public class BasicExtentReport extends BaseTest {
 * 
 * //builds a new report using the html template ExtentHtmlReporter
 * htmlReporter;
 * 
 * public static ExtentReports extent; //helps to generate the logs in test
 * report. public static ExtentTest test;
 * 
 * @Parameters({ "OS", "browser" })
 * 
 * @BeforeTest public void startReport(String OS, String browser) { //
 ...
 * extent.setSystemInfo("OS", OS); extent.setSystemInfo("Browser", browser);
 * 
