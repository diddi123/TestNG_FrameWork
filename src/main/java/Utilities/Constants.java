...
public class Constants {
	...
	public final static String REPORT_DIRECTORY = WORKING_DIRECTORY + "/test-output/testReport.html";
	...
	public final static String PROPERTY_FILE_PATH = WORKING_DIRECTORY + "/src/main/java/config.properties";
}
